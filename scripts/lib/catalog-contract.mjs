...
export const RELEASE_INVENTORY = {
  ...
  // 0.6.0 adds research and restores scoped automatic plan-lifecycle selection.
  '0.6.0': {
    skills: [
      'codebase-design',
      'docs-hygiene',
  ...
  // 0.6.3 keeps asynchronous questions visible and resumes settled planning directly.
  '0.6.3': {
    skills: [
      'codebase-design',
      'docs-hygiene',
  ...
  // 0.7.0 adopts task-owned actions, explicit holds, and manual delivery-age retirement.
  '0.7.0': {
    skills: [
      'codebase-design',
      'docs-hygiene',
  ...
  // 0.7.1 defaults omitted worklog inputs while preserving the skill inventory and invocation gates.
  '0.7.1': {
    skills: [
      'codebase-design',
      'docs-hygiene',
