...
node scripts/install-repository.mjs --repo <root> --plugin agent-workflow-core \
  --catalog-root dev-setup/catalog --ref agent-workflow-core--v0.7.1 --update --apply
```
...
- Release tag: `agent-workflow-core--v0.7.1`
